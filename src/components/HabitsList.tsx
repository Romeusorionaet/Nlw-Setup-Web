import {Check, TextHOne} from 'phosphor-react'
            ...
            {habitsInfo?.possibleHabits.map(habit => {
                return(
                    <Checkbox.Root
                        ...
                        className='flex gap-3 items-center group focus:outline-none disabled:cursor-not-allowed'
                            >
                        <div 
                        ...
                        <span className='font-semibold text-xl text-white loading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400'>
                            {habit.title}
                        </span>
                    </Checkbox.Root>
                )
